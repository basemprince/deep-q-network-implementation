...
class Deep_Q():
    ...
    def __init__(self):
        ...
        self.env = Hybrid_Pendulum(JOINT_COUNT, NU, dt=0.1)
        self.nx = self.env.nx
        self.nv = self.env.nv      
    ...
    def create_folder_backup(self):
        ...
        FOLDER = directory + '/Q_weights_backup/model_' + MODEL_NUM + '/'
        print('saving models into directory:' + FOLDER)
    ...
    def get_critic(self,name):
        ...
        * returns a neural network keras model'''
        inputs = layers.Input(shape=(1,self.nx+JOINT_COUNT),batch_size=MINI_BATCH_SIZE)
